...
public class GameDAO {
    ...
    public List<Game> getAllGames() {
        ...
        String sql = "SELECT j.id, j.titulo, j.genero, j.preco, c.id AS categoria_id, c.nome AS categoria_nome " +
                     "FROM jogo j " +
    ...
    public boolean updateGame(Game game) {
        String sql = "UPDATE jogo SET titulo = ?, genero = ?, preco = ?, categoria_id = ? WHERE id = ?";
